/obj/item/weapon/gun/energy/pulse_rifle
	name = "pulse rifle"
	cases = list("импульсная энерговинтовка","импульсной энерговинтовки","импульсной энерговинтовке","импульсную энерговинтовку","импульсной энерговинтовкой","импульсной энерговинтовке")
